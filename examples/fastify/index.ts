...
// Register Surf plugin — mounts all routes automatically
...
app.listen({ port: PORT, host: '0.0.0.0' }, (err, address) => {
  ...
  console.log(`🏄 Store running at ${address}`);
  console.log(`   Manifest: ${address}/.well-known/surf.json`);
  console.log(`   Execute:  POST ${address}/surf/execute`);
});
